...
$checkQuery = "SELECT sankhye FROM `$c_escaped`.hastacalita_phalitansa_zehn WHERE sthiti='1' LIMIT 1";
...
if ($checkResult && mysqli_num_rows($checkResult) > 0) {
	...
	if($samasyesreni['atadaaidi'] != null){
		$checkSettled = mysqli_query($conn, "SELECT shonu FROM `gellaluhogiondu_phalitansa_zehn` WHERE kalaparichaya = '".$samasyesreni['atadaaidi']."' LIMIT 1");
