...
$dekhakalakrama = mysqli_query($conn,"select atadaaidi from `gelluonduhogu_trx5` order by kramasankhye desc limit 1");
...
if($kaladhadi == null){
	...
	$katiba = mysqli_query($conn,"TRUNCATE TABLE `gelluonduhogu_trx5`");
