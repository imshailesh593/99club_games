...
import {
    D as mt
} from "./page-activity-PointMall-ecc6d510.js";
const Le = m(!1);
...
function Ze() {
    ...
    async function t(p, n) {
        nt(p), g.value = p, k.updateLanguage(p), await rt(p), lt().upUserLanguage(), it(_e.global.t), localStorage.setItem("needUpd", "1"), n === 1 ? c() : Le.value = !1
    }
    const c = () => {
            u.back()
        },
        ...
        setup(g) {
            ...
            return (c, s) => {
                const a = E("van-radio"),
                    p = E("van-radio-group");
                return h(), b("div", {
                    class: M(g.type === 2 ? "list info" : "list")
                }, [(h(!0), b(Se, null, Qe(o(u), (n, d) => (h(), b("div", {
                    class: M(["item ar-1px-b", n.key == o(t) ? "checked" : ""]),
                    key: d,
                    onClick: _ => o(k)(n.key, g.type)
                }, [e("div", _t, [e("img", {
                    src: o(Ce)("languages", n.key)
                }, null, 8, ft), g.type === 2 ? (h(), b("span", ht, r(n.key.toLocaleUpperCase()), 1)) : (h(), b("span", wt, r(n.name), 1))]), y(p, {
                    modelValue: o(t),
                    "onUpdate:modelValue": s[0] || (s[0] = _ => Ve(t) ? t.value = _ : null)
                }, {
                    default: z(() => [y(a, {
                        name: n.key
                    }, null, 8, ["name"])]),
...
const bt = H(yt, [
        ...
        ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/components/Main/LanguageList/index.vue"]
    ]),
    kt = {
        class: "img"
    },
    ...
    $t = A({
        ...
        setup(g) {
            ...
            return (a, p) => {
                ...
                ]), e("span", St, r(o(k)(o(u))), 1)])) : U("v-if", !0), y(n, {
                    show: o(t),
                    "onUpdate:show": p[1] || (p[1] = _ => Ve(t) ? t.value = _ : null),
                    class: "popup",
                    position: "bottom",
                    teleport: "body"
                }, {
...
const Ct = H($t, [
        ...
        ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/components/Login/LangPopup.vue"]
    ]),
    It = {
        class: "popups"
    },
        ...
        setup(g, {
            ...
            return (_, i) => {
                ...
                return h(), b("div", It, [y(C, {
                    ...
                    default: z(() => [e("div", Pt, [e("div", Tt, r(o(c)("googleVerification")), 1), e("div", Ft, [e("div", Rt, [e("p", xt, r(o(c)("googleTip5")), 1), e("p", Et, r(o(c)("googleTip6")), 1)]), e("div", Lt, [D(e("input", {
                        class: "input",
                        type: "text",
                        ...
                        onClick: d
                    }, r(o(c)("contactServicer")), 1)])]), e("div", Nt, [D((h(), b("div", null, [B(r(o(c)("confirm")), 1)])), [
                        [l, {
                            handler: p,
                            wait: 1e3
                        }]
...
const We = H(Dt, [
        ...
        ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/components/Main/VerifyPopup/index.vue"]
    ]),
    se = g => (ve("data-v-869b9ee0"), g = g(), me(), g),
    Ut = ["src"],
    qt = ["src"],
    At = {
        key: 1,
    ...
    us = A({
        ...
        setup(g, {
            ...
            const t = g,
                ...
                Fe = () => {
                    a.value = 0, p.value = 0, i.value = [], s.value = !1, _.value = !1, $.value = !1, l.value = !1, C.value = !1, V.value = !1, Z && (Z.value.style.width = 0), v && (v.value.style.left = 0), T && (T.value.style.left = 0)
                },
                Re = () => {
                    window.removeEventListener("touchmove", fe), window.removeEventListener("touchend", he), window.removeEventListener("mousemove", fe), window.removeEventListener("mouseup", he)
                },
                xe = N => {
                    !V.value && F.value && P.value && !_.value && (window.addEventListener("touchmove", fe), window.addEventListener("touchend", he), window.addEventListener("mousemove", fe), window.addEventListener("mouseup", he), s.value = !0, f.value = new Date, a.value = N.pageX || N.touches[0].pageX, p.value = N.pageY || N.touches[0].pageY)
                },
                fe = N => {
                    if (s.value && !V.value && F.value && P.value && !_.value) {
                        const X = (N.pageX || N.touches[0].pageX) - a.value,
                            ke = (N.pageY || N.touches[0].pageY) - p.value;
                        T.value.style.left = X + "px", Z.value.style.width = X + t.barHeight / 2 + "px", v.value.style.left = X + "px", i.value.push({
                            x: Math.round(X),
                            y: Math.round(ke),
                ...
                he = () => {
                    s.value && !V.value && F.value && P.value && !_.value && (s.value = !1, _.value = !0, Re(), u("finish", {
                ...
                Xe = () => {
                    I.value.style.setProperty("--textColor", "#333"), I.value.style.setProperty("--width", Math.floor(t.width / 2) + "px"), I.value.style.setProperty("--pwidth", -Math.floor(t.width / 2) + "px")
                },
                Je = () => {
                    Fe(), u("refresh")
                };
            return k({
                ...
                return h(), J(ke, {
                    show: c.value,
                    "onUpdate:show": X[0] || (X[0] = Ye => c.value = Ye),
                    teleport: "body"
                }, {
                    default: z(() => [e("div", {
                        class: "captcha",
                        ...
                        [G, P.value]
                    ]), C.value ? (h(), b("div", At, [e("div", Mt, [V.value ? (h(), b("svg", zt, Ot)) : (h(), b("svg", Zt, jt))]), e("div", Gt, r(V.value ? g.successTip : g.failTip), 1)])) : U("v-if", !0), $.value ? (h(), b("div", Kt, [Xt, e("div", Jt, r(N.$t("loading")) + "...", 1)])) : U("v-if", !0), l.value ? (h(), b("div", Yt, ts)) : U("v-if", !0)], 4), e("div", {
                        ...
                        xmlns: "http://www.w3.org/2000/svg"
                    }, as, 4))], 38)], 4), g.showRefresh ? (h(), b("div", ns, [e("a", {
...
const je = H(us, [
        ...
        ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/components/Login/SlideCaptcha.vue"]
    ]),
    cs = {
        ...
        setup(g, {
            ...
            async function _() {
                ...
                if (p.currentRoute.value.name === "rpwd" || p.currentRoute.value.name === "register" || p.currentRoute.value.name === "SettingC-UpdatePhone" && !u.isShowVerifyT) {
                    if (!(($ = u.number) != null && $.trim())) return q({
            ...
            const i = L(() => {
                ...
                f = l => {
                    const $ = l.target;
                    $.value = $.value.replace(/\s+/g, ""), $.value = $.value.replace(/[^\d]/g, "")
                };
            ...
            return (l, $) => {
                ...
                }, [o(c).countDown === 0 ? (h(), b("span", _s, r(l.$t("send")), 1)) : (h(), b("span", fs, r(o(c).countDown) + "S ", 1))], 2)]), D(e("div", hs, [y(P, {
                    name: "warning-o"
...
const ys = H(ws, [
        ...
        ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/components/Login/VerifyInput.vue"]
    ]),
    bs = {
    ...
    Is = A({
        ...
        setup(g, {
            ...
            const p = S => {
                    ...
                    const W = /[\u4e00-\u9fa5]/g;
                    R.value = R.value.replace(W, ""), i(x, R.value), f(R.value), C(x)
                },
                n = m(!1),
                d = L(() => n.value ? de("main", "eyeVisible") : de("main", "eyeInvisible")),
                _ = () => {
                    var S = {
                        start: 0,
                        end: 0
                    };
                    return S.start = c.value.selectionStart, S.end = c.value.selectionEnd, S
                },
                i = (S, x) => {
                    ...
                    let R = x.split("•").join("");
                    if (R) {
                        let W = s.value.length - (x.length - S.end);
                        s.value = s.value.slice(0, S.end - R.length) + R + s.value.slice(W)
                    } else s.value = s.value.slice(0, S.end) + s.value.slice(S.end + s.value.length - x.length)
                },
                f = S => {
                    if (n.value) return;
                    if (!S) {
                    ...
                    let x = "";
                    for (let R = 0; R < S.length; R++) x += "•";
                    c.value.value = x
                },
                C = S => {
                    c.value.setSelectionRange(S.start, S.end)
                },
                l = () => {
                    a.value = !0
                },
                $ = S => {
                    a.value && (a.value = !1, p(S))
                },
                F = () => {
            ...
            return (S, x) => {
                const R = E("svg-icon");
                return h(), b("div", bs, [e("div", ks, [y(R, {
                    name: "editPswIcon",
                    class: "passwordInput__container-label__icon"
                }), e("span", null, r(S.label), 1)]), e("div", Ss, [e("input", {
...
const le = H(Is, [
        ...
        ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/components/Login/PasswordInput.vue"]
    ]),
    Ie = {
    ...
    Pe = g => (ve("data-v-ab583a3a"), g = g(), me(), g),
    Ts = {
        class: "RpwdPopup"
    },
    Fs = {
    ...
    qs = A({
        ...
        setup(g, {
            ...
            const {
                ...
                await re(Ae($)) && (ye(t("rpdsucceed")), localStorage.clear(), k("update:show", !1))
            }, f = () => {
                c()
            };
            return (C, l) => {
                const $ = E("svg-icon"),
                    F = E("van-popup");
                return h(), b(Se, null, [U(" 规则弹层 begin"), y(F, {
                    show: d.value,
                    "onUpdate:show": l[4] || (l[4] = P => d.value = P),
                    "close-on-click-overlay": !1,
                    position: "bottom",
                    round: ""
                }, {
                    default: z(() => [e("div", Ts, [e("div", Fs, r(o(t)("idlockTitle")), 1), e("div", Rs, [B(r(o(t)("idlockTip1", [g.passwordErrorMaxNum])), 1), xs, B(r(o(t)("idlockTip3")), 1)]), y(ys, {
                        value: n.value.smsvcode,
                        "onUpdate:value": l[0] || (l[0] = P => n.value.smsvcode = P),
                        ...
                        "onUpdate:value": l[1] || (l[1] = P => n.value.password = P),
                        label: o(t)("newPSWRest")
                    }, null, 8, ["value", "label"]), D(e("div", Es, [Ls, e("span", null, r(o(t)("pswRule")), 1)], 512), [
                        [G, s.value]
                    ]), y(le, {
                        value: n.value.rePassword,
                        "onUpdate:value": l[2] || (l[2] = P => n.value.rePassword = P),
                        label: o(t)("newPSWconfirm")
                    }, null, 8, ["value", "label"]), e("div", Vs, [p.value ? (h(), b("span", Bs, r(o(t)("unmatchedInput")), 1)) : U("v-if", !0)]), e("div", {
                        ...
                        class: "dialogBtn",
                        onClick: l[3] || (l[3] = P => k("update:show", !1))
                    }, r(o(t)("cancel")), 1)])])]),
                    _: 1
                }, 8, ["show"])], 2112)
            }
...
const As = H(qs, [
        ...
        ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/components/Login/RpwdPopup.vue"]
    ]),
    Ms = {
    ...
    Zs = A({
        ...
        setup(g, {
            ...
            return k({
                ...
                const C = E("svg-icon"),
                    l = we("only-num");
                return h(), b("div", Ms, [e("div", zs, [y(C, {
                    name: "phone"
...
const Ws = H(Zs, [
        ...
        ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/components/Login/PhoneInput.vue"]
    ]),
    js = g => (ve("data-v-33f88764"), g = g(), me(), g),
    Gs = {
        ...
        setup(g, {
            ...
            async function l() {
                if (!C) {
                    ...
                    a.userForm.numberType = a.getUserForm.numberType.replace("+", ""), a.userForm.remember && a.userForm.password.toString().trim() !== "" ? localStorage.setItem("remember", a.userForm.password) : localStorage.setItem("remember", ""), a.isOpenCaptcha && !S.value ? oe() : (s(!0), await a.signIn(a.userForm).then(v => {
                        a.userForm.vCode = "", console.log("res", v)
                    }).catch(v => {
                        var T;
                        console.log("登陆错误1", v), S.value = !1, v.code === 1 && (i.value = ((T = v.data) == null ? void 0 : T.passwordErrorMaxNum) || 10), v.msgCode === 33 ? j(() => I.value = !0) : w(v.msgCode || 0)
                    }).finally(() => {
            ...
            Be(window, "keydown", v => {
                ...
                localStorage.getItem("remember") != null && ((T = localStorage.getItem("remember")) == null ? void 0 : T.toString().trim()) != "" ? v.password = localStorage.getItem("remember") : v.password = "", a.setUserForm({ ...v
                })
            });
            let ue = $e(() => a.userForm.number, v => {
                a.setCountDown(0)
            }, {
                flush: "post"
            });
            const ae = async v => {
                    j(async () => {
                        R.value.startRequestVerify(), s(!0), a.signIn(Object.assign(a.userForm, {
                            captchaId: W.value,
                            track: v
                        })).then(T => {
                            console.log("res", T)
                            ...
                            var ne;
                            console.log("登陆错误", T), T.code === 1 && (i.value = ((ne = T.data) == null ? void 0 : ne.passwordErrorMaxNum) || 10), T.msgCode === 33 ? (j(() => I.value = !0), S.value = !0) : w(T.msgCode || 0)
                        }).finally(() => {
                            R.value.setShowHiden(!1), s(!1)
                        })
                    })
                ...
                oe = () => {
                    j(async () => {
                        ...
                        const v = await re(He());
                        v ? (W.value = v.data.captchaId, R.value.endRequestGenerate(v.data.backgroundImage, v.data.sliderImage)) : R.value.endRequestGenerate(null, null)
                    })
                },
                w = v => {
                    v == 122 && (p.value = !0)
            ...
            return k({
                ...
                return h(), b("div", Gs, [y(Ws, {
                    ...
                    "onUpdate:showValidate": T[0] || (T[0] = O => _.value = O),
                    ref_key: "phone",
                    ref: f,
                    type: c.value,
                    ...
                    "onUpdate:value": T[1] || (T[1] = O => o(a).userForm.password = O),
                    label: v.$t("password"),
                    maxlength: 32
                }, null, 8, ["value", "label"]), e("div", null, [y(ne, {
                    modelValue: o(a).userForm.rememberpwd,
                    "onUpdate:modelValue": T[2] || (T[2] = O => o(a).userForm.rememberpwd = O)
                }, {
                    default: z(() => [B(r(v.$t("rememberPSW")), 1)]),
                    _: 1
                }, 8, ["modelValue"])]), e("div", Ks, [e("button", {
                    class: M([o(a).userForm.number != "" ? "active" : ""]),
                    onClick: l
                }, r(v.$t("login")), 3), e("button", {
                    class: "register",
                    onClick: $
                }, r(v.$t("register")), 1)]), e("div", Xs, [o(a).isOpenForgetPasswordSMSState || o(a).isOpenForgetPasswordEmailState ? (h(), b("div", {
                    key: 0,
                    class: "forgetcon",
                    onClick: F
                }, [y(ce, {
                    name: "clock_b",
                    class: "forgetbg"
                }), e("div", Js, r(v.$t("forgetPSW")), 1)])) : U("v-if", !0), e("div", {
                    class: "customcon",
                    onClick: P
                }, [o(d) ? (h(), J(ce, {
                    key: 0,
                    ...
                    onFinish: ae,
                    onRefresh: oe
                }, null, 8, ["text"]), U("10锁定密码弹窗"), o(a).isOpenForgetPasswordSMSState && p.value ? (h(), J(As, {
                    key: 0,
                    show: p.value,
                    "onUpdate:show": T[3] || (T[3] = O => p.value = O),
                    phoneNumber: o(a).getUserForm.number,
                    phoneNumberType: o(a).getUserForm.numberType,
                    passwordErrorMaxNum: i.value
                }, null, 8, ["show", "phoneNumber", "phoneNumberType", "passwordErrorMaxNum"])) : (h(), J(Oe, {
                    key: 1,
                    show: p.value,
                    "onUpdate:show": T[5] || (T[5] = O => p.value = O),
                    "show-cancel-btn": !0,
                    title: v.$t("idlockTitle")
                }, {
                    content: z(() => [e("div", Qs, [B(r(v.$t("idlockTip1", [i.value])) + " ", 1), eo, B(r(v.$t("idlockTip2")), 1)])]),
                    footer: z(() => [e("button", {
                        class: "dialogBtn",
                        onClick: T[4] || (T[4] = O => p.value = !1)
                    }, r(v.$t("cancel")), 1), e("button", {
                        class: "dialogBtn",
                        onClick: ie
                    }, [e("img", {
                        src: o(de)("main", "iconservr")
                    }, null, 8, to), B(" " + r(v.$t("contactServicer")), 1)])]),
                    _: 1
...
const oo = H(so, [
        ...
        ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/components/Login/SignIn.vue"]
    ]),
    ao = {
        class: "verifyInput__container"
    },
...
const go = H(mo, [
        ...
        ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/components/Login/VerifyEmailInput.vue"]
    ]),
    Te = g => (ve("data-v-95ce4137"), g = g(), me(), g),
    _o = {
        class: "RpwdPopup"
    },
    fo = {
        ...
        setup(g, {
            ...
            return (C, l) => {
                ...
                return h(), b(Se, null, [U(" 规则弹层 begin"), y(F, {
                    ...
                    default: z(() => [e("div", _o, [e("div", fo, r(o(t)("idlockTitle")), 1), e("div", ho, [B(r(o(t)("idlockTip1", [g.passwordErrorMaxNum])), 1), wo, B(r(o(t)("idlockTip3")), 1)]), y(go, {
                        value: n.value.smsvcode,
                        "onUpdate:value": l[0] || (l[0] = P => n.value.smsvcode = P),
                        sendFunc: _,
                        email: g.email,
                        ...
                        "onUpdate:value": l[2] || (l[2] = P => n.value.rePassword = P),
                        label: o(t)("newPSWconfirm")
                    }, null, 8, ["value", "label"]), e("div", ko, [p.value ? (h(), b("span", So, r(o(t)("unmatchedInput")), 1)) : U("v-if", !0)]), e("div", {
                        class: "gotuserver",
                        onClick: f
                    }, [y($, {
                        name: "customer1"
...
const To = H(Po, [
        ...
        ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/components/Login/EmailRpwdPopup.vue"]
    ]),
    Fo = {
    ...
    Vo = A({
        ...
        setup(g, {
            ...
            function a(d) {
                const _ = d.target,
                    i = /[\u4e00-\u9fa5]/g;
                _.value = _.value.replace(i, ""), _.value.length > 0 && u("update:show-validate", !1)
            }
            const p = m();
            ...
            return k({
                ...
                const i = E("svg-icon");
                return h(), b("div", Fo, [e("div", Ro, [e("div", xo, [y(i, {
                    name: "email",
...
const Bo = H(Vo, [
        ...
        ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/components/Login/EmailInput.vue"]
    ]),
    No = g => (ve("data-v-436a69c4"), g = g(), me(), g),
    Do = {
        class: "signIn__container"
    },
    Uo = {
        ...
        setup(g) {
            ...
            async function C() {
                if (ze() && await new Promise(w => setTimeout(w, 500)), !(!s.userForm.email || s.userForm.email.toString().trim() === "")) {
                    ...
                    s.userForm.remember && s.userForm.password.toString().trim() !== "" ? localStorage.setItem("remember", s.userForm.password) : localStorage.setItem("remember", ""), s.isOpenCaptcha && !f.value ? ae() : (c(!0), await s.signIn(s.userForm).then(w => {
                        console.log("res", w)
                    }).catch(w => {
                        var I;
                        f.value = !1, w.code === 1 && (t.value = ((I = w.data) == null ? void 0 : I.passwordErrorMaxNum) || 10), w.msgCode === 33 ? d.value = !0 : oe(w.msgCode || 0)
                    }).finally(() => {
            ...
            ge(async () => {
                ...
                localStorage.getItem("remember") != null && ((I = localStorage.getItem("remember")) == null ? void 0 : I.toString().trim()) != "" ? w.password = localStorage.getItem("remember") : w.password = "", s.setUserForm({ ...w
                })
            });
            let ie = $e(() => s.userForm.number, w => {
                s.setCountDown(0)
            }, {
                flush: "post"
            });
            const ue = async w => {
                    j(async () => {
                        V.value.startRequestVerify(), c(!0), s.signIn(Object.assign(s.userForm, {
                            ...
                            s.userForm.vCode = "", console.log("res", I)
                        }).catch(I => {
                            var Z;
                            console.log("登陆错误", I), I.code === 1 && (t.value = ((Z = I.data) == null ? void 0 : Z.passwordErrorMaxNum) || 10), I.msgCode === 33 ? (j(() => d.value = !0), f.value = !0) : oe(I.msgCode || 0)
                        }).finally(() => {
                            V.value.setShowHiden(!1), c(!1)
                        })
                    })
                ...
                ae = () => {
                    j(async () => {
                        ...
                        const w = await re(He());
                        w ? (S.value = w.data.captchaId, V.value.endRequestGenerate(w.data.backgroundImage, w.data.sliderImage)) : V.value.endRequestGenerate(null, null)
                    })
                },
                oe = w => {
                    w == 122 && (a.value = !0)
            ...
            return Ne(() => {
                ...
                return h(), b("div", Do, [y(Bo, {
                    ...
                    "onUpdate:value": I[0] || (I[0] = v => o(s).userForm.password = v),
                    label: w.$t("password"),
                    maxlength: 32
                }, null, 8, ["value", "label"]), e("div", null, [y(Z, {
                    modelValue: o(s).userForm.rememberpwd,
                    "onUpdate:modelValue": I[1] || (I[1] = v => o(s).userForm.rememberpwd = v)
                }, {
                    default: z(() => [B(r(w.$t("rememberPSW")), 1)]),
                    _: 1
                    ...
                    name: "clock_b",
                    class: "forgetbg"
                }), e("div", Ao, r(w.$t("forgetPSW")), 1)])) : U("v-if", !0), e("div", {
                    class: "customcon",
                    onClick: F
                }, [o(n) ? (h(), J(K, {
                    key: 0,
                    ...
                    name: "customer_b",
                    class: "forgetbg"
                })), e("div", Mo, r(o(n) ? o(u)("serverTicket") : w.$t("customerServiceTitle")), 1)])]), y(je, {
                    ref_key: "captchaRef",
                    ref: V,
                    "refresh-color": "#FFFFFF",
                    "show-refresh": !0,
                    ...
                    onFinish: ue,
                    onRefresh: ae
                }, null, 8, ["text"]), U("10锁定密码弹窗"), o(s).isOpenForgetPasswordEmailState && a.value ? (h(), J(To, {
                    key: 0,
                    show: a.value,
                    "onUpdate:show": I[2] || (I[2] = v => a.value = v),
                    email: o(s).getUserForm.email,
                    passwordErrorMaxNum: t.value
                }, null, 8, ["show", "email", "passwordErrorMaxNum"])) : (h(), J(Oe, {
                    key: 1,
                    show: a.value,
                    "onUpdate:show": I[4] || (I[4] = v => a.value = v),
                    "show-cancel-btn": !0,
                    title: w.$t("idlockTitle")
                }, {
                    content: z(() => [e("div", zo, [B(r(w.$t("idlockTip1", [t.value])) + " ", 1), Ho, B(r(w.$t("idlockTip2")), 1)])]),
                    footer: z(() => [e("button", {
                        class: "dialogBtn",
                        onClick: I[3] || (I[3] = v => a.value = !1)
                    }, r(w.$t("cancel")), 1), e("button", {
                        class: "dialogBtn",
                        onClick: x
                    }, [e("img", {
                        src: o(de)("main", "iconservr")
                    }, null, 8, Oo), B(" " + r(w.$t("contactServicer")), 1)])]),
                    _: 1
                }, 8, ["show", "title"])), U(" 验证弹窗 "), y(We, {
                    showPopup: d.value,
                    onOnConfirm: R,
...
const Wo = H(Zo, [
        ...
        ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/components/Login/EmailSignIn.vue"]
    ]),
    jo = {
    ...
    sa = A({
        ...
        setup(g) {
            ...
            return st((d, _, i) => {
                ...
                const d = (await ot(() =>
                    import ("./chunk.fingerprintjs-e0490b82.js"), ["assets/js/chunk.fingerprintjs-e0490b82.js", "assets/js/common.modules-5cfe2cf4.js", "assets/css/common-05d2aa17.css"])).default;
                ...
                return h(), b("div", {
                    ...
                    right: z(() => [y(Ct)]),
                    _: 1
                }), e("div", jo, [e("h1", Go, r(o(k)("login")), 1), e("div", Ko, [e("div", null, r(d.$t("pleaseloginphoneoremail")), 1), e("div", null, r(d.$t("forgetyourpassword")), 1)])]), e("div", Xo, [e("div", {
                    class: M(["tab", [c.value == "mobile" ? "active" : ""]]),
                    onClick: _[0] || (_[0] = C => n("mobile"))
                }, [y(f, {
                    name: "phone"
                }), e("div", null, r(d.$t("phoneN")), 1)], 2), e("div", {
                    class: M(["tab", [c.value == "email" ? "active" : ""]]),
                ...
                ])]), e("div", null, r(o(t).isOpenExternalAccount ? d.$t("otherlogin") : d.$t("emaillogin")), 1)], 2)]), e("div", Jo, [e("div", {
                    class: M(["tab-content", [c.value == "mobile" ? "activecontent" : ""]])
                }, [y(oo, {
                    ref: "signIn"
                }, null, 512)], 2), e("div", {
                    class: M(["tab-content", [c.value == "email" ? "activecontent" : ""]])
                }, [y(Wo, {
                    ref: "signIn"
                }, null, 512)], 2)])], 512)
            }
