        ...
        setup(c) {
            ...
            return B(() => {
                ...
                return r(), a("div", $, [_(T, {
                    ...
                    "left-arrow": "",
                    onClickLeft: d[0] || (d[0] = n => s(v).go(-1))
                    ...
                    key: i
                }, [t("div", U, [t("div", W, [t("span", Y, "L" + e(n.lv), 1)])]), t("div", Z, e(n.lvCount), 1), t("div", tt, e(s(x)(n.lotteryAmount)), 1), t("div", ot, e(s(x)(n.rechargeAmount)), 1)]))), 128))]), t("div", et, [_(m, {
                    name: "ruleHead"
                }), st, t("div", nt, [L(e(s(o)("promotionRuleDesc5")) + " ", 1), t("p", null, e(s(o)("promotionRuleRedTXT")), 1), t("div", {
                    class: "txt",
                    onClick: d[1] || (d[1] = n => s(v).push({
                        name: "RebateRatio"
                    }))
...
const pt = V(rt, [
    ...
    ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/views/promotion/PromotionRule/index.vue"]
]);
export {
    pt as
    default
