    ...
    Dt = S({
        ...
        setup(v) {
            ...
            return j(() => {
                ...
                const T = $("NavBar"),
                    g = $("svg-icon");
                return d(), _("div", it, [u(T, {
                    title: l.$t("activityTurntable"),
                    class: "white",
                    placeholder: !1,
                    "left-arrow": "",
                    onClickLeft: n(J)
                }, null, 8, ["title", "onClickLeft"]), rt, t("div", ut, [t("div", ct, [t("div", dt, [t("h3", null, e(l.$t("code9101")), 1), t("img", {
                    class: "svg",
                ...
                }, null, 8, ["onStart", "onEnd", "prizes", "width", "height"])) : P("v-if", !0)], 512), t("ul", $t, [t("li", {
                    ...
                    name: "activityRule"
                }), t("p", null, e(l.$t("firstSaveRule")), 1)])]), t("div", yt, [u(g, {
                    name: "historyHead"
                    ...
                    content: D(() => [t("ul", null, [(d(!0), _(z, null, M(n(r).turntableRecord, (s, R) => (d(), _("li", {
                        key: R
                    }, [t("div", null, [t("p", null, e(s.drawTime), 1)]), t("div", St, e(q[s.rewardType]), 1), s.rewardType === 1 ? (d(), _("div", Lt, e(n(w)(s.rewardAmount)), 1)) : (d(), _("div", Nt, e(s.rewardSetting), 1))]))), 128))])]),
                    _: 1
...
const At = L(Dt, [
        ...
        ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/views/activity/Turntable/index.vue"]
    ]),
    ...
    Ft = S({
        ...
        setup(v) {
            ...
            return j(() => {
                ...
                const k = $("NavBar");
                return d(), _("div", Pt, [u(k, {
                    title: a.$t("activityDestitle"),
                    placeholder: !1,
                    "left-arrow": "",
                    onClickLeft: n(h)
                }, null, 8, ["title", "onClickLeft"]), t("div", zt, [t("div", Mt, [t("div", xt, [t("div", Ot, [t("div", Ht, e(a.$t("turntableTask")), 1), t("div", Et, e(a.$t("turntableCount")), 1), t("div", Vt, e(a.$t("turntableTime")), 1)]), t("ul", null, [(d(!0), _(z, null, M(n(b).taskList, (y, N) => (d(), _("li", {
                    key: N
                }, [t("div", null, [t("p", Wt, e(n(w)(y.targetAmount)), 1), t("p", null, e(r[y.taskType]) + e(a.$t("amount")), 1)]), t("div", Jt, "+" + e(y.rotateNum), 1), Qt]))), 128))])])])]), u(et, {
                    name: a.$t("rule"),
                    render: "html",
                    tiplist: i.value
                }, {
                    default: D(() => [t("div", Ut, [t("p", null, e(a.$t("example")) + "：", 1), f.value ? (d(), _("p", {
                        key: 0,
...
const Gt = L(Ft, [
        ...
        ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/views/activity/Turntable/Detail/index.vue"]
    ]),
        ...
        setup(v) {
            ...
            return j(() => {
                ...
                return d(), _("div", Kt, [u(f, {
                    ...
                    innerHTML: i.$t("turntableSatisfy", [n(c).vipRating.join("、")])
                }, null, 8, ie), [0, -1].includes(n(c).bindingType) ? P("v-if", !0) : (d(), _("p", re, [B(e(i.$t("turntableBind")) + " ", 1), t("span", null, e(n(h)[n(c).bindingType] || ""), 1)])), t("p", null, e(i.$t("turntablePrize")), 1)])])])
            }
        }
    });
const ce = L(ue, [
        ["__scopeId", "data-v-5165b274"],
        ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/views/activity/Turntable/Introduce/index.vue"]
    ]),
    ...
    be = S({
        ...
        setup(v) {
            const p = H(),
                ...
                b = C([{
                    title: c("introduceTitle"),
                    content: c("introduceContent")
                }, {
                    title: c("introduceTitle2"),
                    content: c("introduceContent2")
                }, {
                    title: c("introduceTitle3"),
                    content: c("introduceContent3")
                }]);
            return (h, i) => {
                const r = $("NavBar"),
                    f = $("svg-icon");
                return d(), _("div", de, [u(r, {
                    title: h.$t("firstSaveRule"),
                    placeholder: !1,
                    "left-arrow": "",
                    onClickLeft: i[0] || (i[0] = a => n(p).go(-1))
                }, null, 8, ["title"]), t("div", _e, [(d(!0), _(z, null, M(b.value, (a, m) => (d(), _("div", {
                    class: "promotion-box",
                    key: m
...
const he = L(be, [
        ...
        ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/views/activity/Turntable/Rules/index.vue"]
    ]),
...
export {
    we as a, ke as b, Te as c, ye as i
};