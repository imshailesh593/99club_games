    ...
    Je = T({
        ...
        setup(e, {
            ...
            return H(() => n.show, f => {
                ...
                default: k(() => [R(s("div", Ze, [qe, e.showClose ? (w(), C("div", {
                    key: 0,
...
const Ye = pe(Je, [
        ...
        ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/components/Dialog/Dialog.vue"]
    ]),
    Qe = e => {
        const o = J(),
            {
        ...
        setup(e, {
            ...
            return H(g, () => {
                ...
                const z = M("van-button"),
                    ...
                    Ce = M("van-picker"),
                    ke = M("van-popup");
                return w(), C("div", yt, [s("div", mt, [gt, oe(d.$slots, "header", {}, () => [S.value ? (w(), C("h5", wt, m(r(h)("SMSVerify")), 1)) : (w(), C("h5", _t, m(r(g).title), 1))], !0), Ct]), s("div", kt, [x.value.value === "mobile" || S.value ? (w(), C("div", bt, [s("div", St, [s("p", null, m(d.$t("tipVerifyIdentityForFundSafety")), 1), s("span", null, m(d.$t("tip6digitVeriCode", [`${r(Ue)(Q.value)} 6`])), 1)]), l(K, {
                    center: "",
                    type: "digit",
                    ...
                    _: 1
                }, 8, ["placeholder", "modelValue"])])) : D("v-if", !0), x.value.value === "email" ? (w(), C("div", $t, [s("div", It, [s("p", null, m(d.$t("tipVerifyIdentityForFundSafety")), 1), s("span", null, m(d.$t("tipemaildigitVeriCode", [r(Le)(((te = (ee = r(P)) == null ? void 0 : ee.verifyMethods) == null ? void 0 : te.email) || "")])), 1)]), l(K, {
                    center: "",
                    type: "digit",
                    maxlength: 6,
                    modelValue: r(t),
                    ...
                    button: k(() => [l(z, {
                        ...
                        default: k(() => [O(m(r(L) ? `${r(q)}S` : d.$t("send")), 1)]),
                        _: 1
                    }, 8, ["disabled"])]),
                    _: 1
                }, 8, ["modelValue", "placeholder"])])) : D("v-if", !0), x.value.value === "google" ? (w(), C("div", xt, [s("div", Bt, [s("p", null, m(d.$t("openauthenticator")), 1), s("p", null, m(d.$t("verificationcodegoogle")), 1)]), l(K, {
                    center: "",
                    clearable: "",
                    maxlength: 6,
                    modelValue: r(t),
...
const jt = pe(zt, [
        ...
        ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/components/SecurityDialog/index.vue"]
    ]),
    Lt = T({
        __name: "index",
        setup(e) {
