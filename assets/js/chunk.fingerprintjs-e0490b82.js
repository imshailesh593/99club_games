...
function se(e, n, t) {
    return t === void 0 && (t = 16), R(this, void 0, void 0, function() {
        var r, a, u, i;
        return M(this, function(s) {
            switch (s.label) {
                case 0:
                    r = Array(e.length), a = Date.now(), u = 0, s.label = 1;
                case 1:
                    return u < e.length ? (r[u] = n(e[u], u), i = Date.now(), i >= a + t ? (a = i, [4, Xe()]) : [3, 3]) : [3, 4];
                case 2:
                    s.sent(), s.label = 3;
                case 3:
                    return ++u, [3, 1];
...
function De(e) {
    for (var n, t, r = "Unexpected syntax '".concat(e, "'"), a = /^\s*([a-z-]*)(.*)$/i.exec(e), u = a[1] || void 0, i = {}, s = /([.:#][\w-]+|\[.+?\])/gi, c = function(d, v) {
            i[d] = i[d] || [], i[d].push(v)
        };;) {
        var f = s.exec(a[2]);
        if (!f) break;
        ...
        switch (l[0]) {
            ...
            case "[":
                {
                    var o = /^\[([\w-]+)([~|^$*]?=("(.*?)"|([\w-]+)))?(\s+[is])?\]$/.exec(l);
                    if (o) c(o[1], (t = (n = o[4]) !== null && n !== void 0 ? n : o[5]) !== null && t !== void 0 ? t : "");
...
function G(e, n) {
    var t = e[0] >>> 16,
        ...
        d = 0,
        v = 0;
    v += u + f, d += v >>> 16, v &= 65535, d += a + c, o += d >>> 16, d &= 65535, o += r + s, l += o >>> 16, o &= 65535, l += t + i, l &= 65535, e[0] = l << 16 | o, e[1] = d << 16 | v
}
...
function C(e, n) {
    var t = e[0] >>> 16,
        ...
        d = 0,
        v = 0;
    v += u * f, d += v >>> 16, v &= 65535, d += a * f, o += d >>> 16, d &= 65535, d += u * c, o += d >>> 16, d &= 65535, o += r * f, l += o >>> 16, o &= 65535, o += a * c, l += o >>> 16, o &= 65535, o += u * s, l += o >>> 16, o &= 65535, l += t * f + r * c + a * s + u * i, l &= 65535, e[0] = l << 16 | o, e[1] = d << 16 | v
}
...
var Be = [4283543511, 3981806797],
    Je = [3301882366, 444984403];

function le(e) {
    var n = [0, e[0] >>> 1];
    g(e, n), C(e, Be), n[1] = e[0] >>> 1, g(e, n), C(e, Je), n[1] = e[0] >>> 1, g(e, n)
}
...
function xe(e, n) {
    ...
    var r = [0, t.length],
        ...
        f = [0, 0],
        l;
    for (l = 0; l < u; l = l + 16) c[0] = t[l + 4] | t[l + 5] << 8 | t[l + 6] << 16 | t[l + 7] << 24, c[1] = t[l] | t[l + 1] << 8 | t[l + 2] << 16 | t[l + 3] << 24, f[0] = t[l + 12] | t[l + 13] << 8 | t[l + 14] << 16 | t[l + 15] << 24, f[1] = t[l + 8] | t[l + 9] << 8 | t[l + 10] << 16 | t[l + 11] << 24, C(c, z), E(c, 31), C(c, B), g(i, c), E(i, 27), G(i, s), C(i, fe), G(i, Oe), C(f, B), E(f, 33), C(f, z), g(s, f), E(s, 31), G(s, i), C(s, fe), G(s, Ue);
    c[0] = 0, c[1] = 0, f[0] = 0, f[1] = 0;
    var o = [0, 0];
    switch (a) {
        case 15:
            o[1] = t[l + 14], V(o, 48), g(f, o);
        case 14:
            o[1] = t[l + 13], V(o, 40), g(f, o);
        case 13:
            o[1] = t[l + 12], V(o, 32), g(f, o);
        case 12:
            o[1] = t[l + 11], V(o, 24), g(f, o);
        case 11:
            o[1] = t[l + 10], V(o, 16), g(f, o);
        case 10:
            o[1] = t[l + 9], V(o, 8), g(f, o);
        case 9:
            o[1] = t[l + 8], g(f, o), C(f, B), E(f, 33), C(f, z), g(s, f);
        case 8:
            o[1] = t[l + 7], V(o, 56), g(c, o);
        case 7:
            o[1] = t[l + 6], V(o, 48), g(c, o);
        case 6:
            o[1] = t[l + 5], V(o, 40), g(c, o);
        case 5:
            o[1] = t[l + 4], V(o, 32), g(c, o);
        case 4:
            o[1] = t[l + 3], V(o, 24), g(c, o);
        case 3:
            o[1] = t[l + 2], V(o, 16), g(c, o);
        case 2:
            o[1] = t[l + 1], V(o, 8), g(c, o);
        case 1:
            o[1] = t[l], g(c, o), C(c, z), E(c, 31), C(c, B), g(i, c)
    }
    return g(i, r), g(s, r), G(i, s), G(s, i), le(i), le(s), G(i, s), G(s, i), ("00000000" + (i[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (i[1] >>> 0).toString(16)).slice(-8) + ("00000000" + (s[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (s[1] >>> 0).toString(16)).slice(-8)
}
...
function $e(e, n, t, r) {
    var a = Object.keys(e).filter(function(i) {
            return He(t, i)
        }),
        u = N(se(a, function(i) {
            return Ke(e[i], n)
            ...
            return M(this, function(d) {
                switch (d.label) {
                    case 0:
                        return [4, u];
                    case 1:
                        return s = d.sent(), [4, se(s, function(v) {
                            return N(v())
                        }, r)];
                    case 2:
                        return c = d.sent(), [4, Promise.all(c)];
                    case 3:
                        for (f = d.sent(), l = {}, o = 0; o < a.length; ++o) l[a[o]] = f[o];
                        return [2, l]
                }
            })
        })
...
function Qt(e, n) {
    var t = function(r) {
        return Ve(r) ? n(r) : function() {
            var a = r();
            return U(a) ? a.then(n) : n(a)
        }
    };
    return function(r) {
        var a = e(r);
        return U(a) ? a.then(t) : t(a)
    }
}
...
function qe() {
    var e = window,
        n = navigator;
    return x(["msWriteProfilerMark" in e, "MSStream" in e, "msLaunchUri" in n, "msSaveBlob" in n]) >= 3 && !Ce()
}
...
function H() {
    var e = window;
    return _e(e.print) && String(e.browser) === "[object WebPageNamespace]"
}
...
function re() {
    var e = j(),
        ...
        r = navigator,
        a = "connection";
    return e ? x([!("SharedWorker" in t), r[a] && "ontypechange" in r[a], !("sinkId" in new Audio)]) >= 2 : n ? x(["onorientationchange" in t, "orientation" in t, /android/i.test(r.appVersion)]) >= 2 : !1
}
...
function sn() {
    ...
    var t = 4500,
        r = 5e3,
        a = new n(1, r, 44100),
        u = a.createOscillator();
    u.type = "triangle", u.frequency.value = 1e4;
    var i = a.createDynamicsCompressor();
    i.threshold.value = -50, i.knee.value = 40, i.ratio.value = 12, i.attack.value = 0, i.release.value = .25, u.connect(i), i.connect(a.destination), u.start(0);
    var s = dn(a),
        c = s[0],
        f = s[1],
        l = N(c.then(function(o) {
            return vn(o.getChannelData(0).subarray(t))
        }, function(o) {
            if (o.name === "timeout" || o.name === "suspended") return -3;
            throw o
        }));
    return function() {
        return f(), l
    ...
    var n = 3,
        ...
        i = new Promise(function(s, c) {
            ...
            var d = function() {
                    setTimeout(function() {
                        return c(de("timeout"))
                    }, Math.min(r, o + a - Date.now()))
                },
                v = function() {
                    try {
                        var b = e.startRendering();
                        switch (U(b) && N(b), e.state) {
                            case "running":
                                o = Date.now(), f && d();
                                break;
                            case "suspended":
                                document.hidden || l++, f && l >= n ? c(de("suspended")) : setTimeout(v, t);
                                break
                        }
                    } catch (y) {
                        c(y)
...
function We(e, n, t) {
    var r, a, u;
    return t === void 0 && (t = 50), R(this, void 0, void 0, function() {
        var i, s;
        return M(this, function(c) {
            switch (c.label) {
                case 0:
                    i = document, c.label = 1;
                case 1:
                    return i.body ? [3, 3] : [4, O(t)];
                case 2:
                    return c.sent(), [3, 1];
                case 3:
                    s = i.createElement("iframe"), c.label = 4;
                case 4:
                    return c.trys.push([4, , 10, 11]), [4, new Promise(function(f, l) {
                        var o = !1,
                            d = function() {
                                o = !0, f()
                            },
                        ...
                        var b = s.style;
                        b.setProperty("display", "block", "important"), b.position = "absolute", b.top = "0", b.left = "0", b.visibility = "hidden", n && "srcdoc" in s ? s.srcdoc = n : s.src = "about:blank", i.body.appendChild(s);
                        var y = function() {
                            var S, h;
                            o || (((h = (S = s.contentWindow) === null || S === void 0 ? void 0 : S.document) === null || h === void 0 ? void 0 : h.readyState) === "complete" ? d() : setTimeout(y, 10))
                        };
                        y()
                    })];
                case 5:
                    c.sent(), c.label = 6;
                case 6:
                    return !((a = (r = s.contentWindow) === null || r === void 0 ? void 0 : r.document) === null || a === void 0) && a.body ? [3, 8] : [4, O(t)];
                case 7:
                    return c.sent(), [3, 6];
                case 8:
                ...
                case 9:
                    return [2, c.sent()];
                case 10:
                    return (u = s.parentNode) === null || u === void 0 || u.removeChild(s), [7];
                case 11:
                    return [2]
            }
        })
...
function mn(e) {
    for (var n = De(e), t = n[0], r = n[1], a = document.createElement(t ? ? "div"), u = 0, i = Object.keys(r); u < i.length; u++) {
        var s = i[u],
            c = r[s].join(" ");
        s === "style" ? hn(a.style, c) : a.setAttribute(s, c)
    }
    return a
}
...
var gn = "mmMwWLliI0O&1",
    ...
    ve = ["sans-serif-thin", "ARNO PRO", "Agency FB", "Arabic Typesetting", "Arial Unicode MS", "AvantGarde Bk BT", "BankGothic Md BT", "Batang", "Bitstream Vera Sans Mono", "Calibri", "Century", "Century Gothic", "Clarendon", "EUROSTILE", "Franklin Gothic", "Futura Bk BT", "Futura Md BT", "GOTHAM", "Gill Sans", "HELV", "Haettenschweiler", "Helvetica Neue", "Humanst521 BT", "Leelawadee", "Letter Gothic", "Levenim MT", "Lucida Bright", "Lucida Sans", "Menlo", "MS Mincho", "MS Outlook", "MS Reference Specialty", "MS UI Gothic", "MT Extra", "MYRIAD PRO", "Marlett", "Meiryo UI", "Microsoft Uighur", "Minion Pro", "Monotype Corsiva", "PMingLiU", "Pristina", "SCRIPTINA", "Segoe UI Light", "Serifa", "SimHei", "Small Fonts", "Staccato222 BT", "TRAJAN PRO", "Univers CE 55 Medium", "Vrinda", "ZWAdobeF"];
...
function yn() {
    ...
    return We(function(n, t) {
        ...
        return R(e, void 0, void 0, function() {
            var a, u, i, s, c, f, l, o, d, v, b, y;
            return M(this, function(S) {
                for (a = r.body, a.style.fontSize = bn, u = r.createElement("div"), u.style.setProperty("visibility", "hidden", "important"), i = {}, s = {}, c = function(h) {
                        var w = r.createElement("span"),
                            L = w.style;
                        return L.position = "absolute", L.top = "0", L.left = "0", L.fontFamily = h, w.textContent = gn, u.appendChild(w), w
                    }, f = function(h, w) {
                        return c("'".concat(h, "',").concat(w))
                    }, l = function() {
                        return Y.map(c)
                    }, o = function() {
                        for (var h = {}, w = function(Z) {
                                h[Z] = Y.map(function(T) {
                                    return f(Z, T)
                                })
                            }, L = 0, I = ve; L < I.length; L++) {
                            var A = I[L];
                            w(A)
                        }
                        return h
                    }, d = function(h) {
                        return Y.some(function(w, L) {
                            return h[L].offsetWidth !== i[w] || h[L].offsetHeight !== s[w]
                        })
                    }, v = l(), b = o(), a.appendChild(u), y = 0; y < Y.length; y++) i[Y[y]] = v[y].offsetWidth, s[Y[y]] = v[y].offsetHeight;
                return [2, ve.filter(function(h) {
                    return d(b[h])
                })]
            })
        })
...
function Ln(e) {
    var n, t = !1,
        ...
        i = u[0],
        s = u[1];
    return xn(i, s) ? (t = Vn(s), e ? r = a = "skipped" : (n = Cn(i, s), r = n[0], a = n[1])) : r = a = "unsupported", {
        winding: t,
        geometry: r,
        text: a
    }
...
function Wn(e, n) {
    ...
    for (var t = 0, r = [
        ...
        var a = r[t],
            ...
            i = a[1],
            s = a[2];
        n.fillStyle = u, n.beginPath(), n.arc(i, s, 40, 0, Math.PI * 2, !0), n.closePath(), n.fill()
    }
...
function Mn() {
    var e = navigator,
        n = 0,
        t;
    e.maxTouchPoints !== void 0 ? n = ne(e.maxTouchPoints) : e.msMaxTouchPoints !== void 0 && (n = e.msMaxTouchPoints);
    try {
...
function Pn() {
    ...
    if (t !== void 0 && n.push([t]), Array.isArray(e.languages)) j() && en() || n.push(e.languages);
...
function Gn() {
    return P(F(navigator.deviceMemory), void 0)
}
...
function Xn() {
    if (K === void 0) {
        var e = function() {
            var n = q();
            ee(n) ? K = setTimeout(e, En) : (J = n, K = void 0)
        };
        e()
    }
}
        ...
        function() {
            return R(e, void 0, void 0, function() {
                ...
                return M(this, function(t) {
                    switch (t.label) {
                        case 0:
                            return n = q(), ee(n) ? J ? [2, Se([], J, !0)] : an() ? [4, on()] : [3, 2] : [3, 2];
                        case 1:
                            t.sent(), n = q(), t.label = 2;
                        case 2:
                            return ee(n) || (J = n), [2, n]
                    }
                })
            ...
            return M(this, function(a) {
                switch (a.label) {
                    case 0:
                        return [4, n()];
                    case 1:
                        return t = a.sent(), r = function(u) {
                            return u === null ? null : ke(u, Yn)
...
function q() {
    var e = screen;
    return [P(F(e.availTop), null), P(F(e.width) - F(e.availWidth) - P(F(e.availLeft), 0), null), P(F(e.height) - F(e.availHeight) - P(F(e.availTop), 0), null), P(F(e.availLeft), null)]
}
...
function Hn() {
    return P(ne(navigator.hardwareConcurrency), void 0)
}
...
function _n() {
    ...
    return e === "MacIntel" && W() && !te() ? rn() ? "iPad" : "iPhone" : e
}
...
function nt(e) {
    ...
    return R(this, void 0, void 0, function() {
        ...
        return M(this, function(f) {
            switch (f.label) {
                case 0:
                    return tt() ? (r = et(), a = Object.keys(r), u = (c = []).concat.apply(c, a.map(function(l) {
                        return r[l]
                    })), [4, rt(u)]) : [2, void 0];
                case 1:
                    return i = f.sent(), t && at(r, i), s = a.filter(function(l) {
                        var o = r[l],
                            d = x(o.map(function(v) {
                                return i[v]
                            }));
                        return d > o.length * .6
                    }), s.sort(), [2, s]
...
function rt(e) {
    ...
    return R(this, void 0, void 0, function() {
        ...
        return M(this, function(f) {
            switch (f.label) {
                case 0:
                    for (t = document, r = t.createElement("div"), a = new Array(e.length), u = {}, me(r), c = 0; c < e.length; ++c) i = mn(e[c]), i.tagName === "DIALOG" && i.show(), s = t.createElement("div"), me(s), s.appendChild(i), r.appendChild(s), a[c] = i;
                    f.label = 1;
                case 1:
                ...
                case 3:
                    ...
                    try {
                        for (c = 0; c < e.length; ++c) a[c].offsetParent || (u[e[c]] = !0)
                    } finally {
...
function at(e, n) {
    for (var t = "DOM blockers debug:\n```", r = 0, a = Object.keys(e); r < a.length; r++) {
        ...
        t += `
`.concat(u, ":");
        for (var i = 0, s = e[u]; i < s.length; i++) {
            var c = s[i];
            t += `
...
function ft() {
    if (ge("reduce")) return !0;
    if (ge("no-preference")) return !1
}
...
function pt() {
    return gt(function(e, n) {
        for (var t = {}, r = {}, a = 0, u = Object.keys($); a < u.length; a++) {
            var i = u[a],
                s = $[i],
                c = s[0],
                f = c === void 0 ? {} : c,
            ...
            d.textContent = o, d.style.whiteSpace = "nowrap";
            for (var v = 0, b = Object.keys(f); v < b.length; v++) {
                var y = b[v],
                    S = f[y];
                S !== void 0 && (d.style[y] = S)
            }
            t[i] = d, n.append(e.createElement("br"), d)
        }
        for (var h = 0, w = Object.keys($); h < w.length; h++) {
            var i = w[h];
...
function gt(e, n) {
    return n === void 0 && (n = 4e3), We(function(t, r) {
        var a = r.document,
            u = a.body,
            i = u.style;
        i.width = "".concat(n, "px"), i.webkitTextSizeAdjust = i.textSizeAdjust = "none", j() ? u.style.zoom = "".concat(1 / r.devicePixelRatio) : W() && (u.style.zoom = "reset");
        var s = a.createElement("div");
        return s.textContent = Se([], Array(n / 20 << 0), !0).map(function() {
            return "word"
        }).join(" "), u.appendChild(s), e(a, u)
...
var Re = -1,
    Me = -2,
    xt = new Set([10752, 2849, 2884, 2885, 2886, 2928, 2929, 2930, 2931, 2932, 2960, 2961, 2962, 2963, 2964, 2965, 2966, 2967, 2968, 2978, 3024, 3042, 3088, 3089, 3106, 3107, 32773, 32777, 32777, 32823, 32824, 32936, 32937, 32938, 32939, 32968, 32969, 32970, 32971, 3317, 33170, 3333, 3379, 3386, 33901, 33902, 34016, 34024, 34076, 3408, 3410, 3411, 3412, 3413, 3414, 3415, 34467, 34816, 34817, 34818, 34819, 34877, 34921, 34930, 35660, 35661, 35724, 35738, 35739, 36003, 36004, 36005, 36347, 36348, 36349, 37440, 37441, 37443, 7936, 7937, 7938]),
    Vt = new Set([34047, 35723, 36063, 34852, 34853, 34854, 34229, 36392, 36795, 38449]),
    Ct = ["FRAGMENT_SHADER", "VERTEX_SHADER"],
    Ft = ["LOW_FLOAT", "MEDIUM_FLOAT", "HIGH_FLOAT", "LOW_INT", "MEDIUM_INT", "HIGH_INT"],
    Ie = "WEBGL_debug_renderer_info",
    Wt = "WEBGL_polygon_mode";

function Rt(e) {
    var n, t, r, a, u, i, s = e.cache,
        c = Pe(s);
    if (!c) return Re;
    if (!Ge(c)) return Me;
    var f = Ze() ? null : c.getExtension(Ie);
    return {
        ...
        vendorUnmasked: f ? (r = c.getParameter(f.UNMASKED_VENDOR_WEBGL)) === null || r === void 0 ? void 0 : r.toString() : "",
        renderer: ((a = c.getParameter(c.RENDERER)) === null || a === void 0 ? void 0 : a.toString()) || "",
        rendererUnmasked: f ? (u = c.getParameter(f.UNMASKED_RENDERER_WEBGL)) === null || u === void 0 ? void 0 : u.toString() : "",
...
function Mt(e) {
    ...
    var r = t.getSupportedExtensions(),
        ...
        f = [];
    if (a)
        for (var l = 0, o = Object.keys(a); l < o.length; l++) {
            var d = o[l];
            i.push("".concat(d, "=").concat(a[d]))
        }
    for (var v = we(t), b = 0, y = v; b < y.length; b++) {
        var S = y[b],
            h = t[S];
        s.push("".concat(S, "=").concat(h).concat(xt.has(h) ? "=".concat(t.getParameter(h)) : ""))
    }
    if (r)
        for (var w = 0, L = r; w < L.length; w++) {
            var I = L[w];
            if (!(I === Ie && Ze() || I === Wt && Zt())) {
                var A = t.getExtension(I);
                if (!A) {
                    u.push(I);
                    continue
                }
                for (var Z = 0, T = we(A); Z < T.length; Z++) {
                    var S = T[Z],
                        h = A[S];
                    c.push("".concat(S, "=").concat(h).concat(Vt.has(h) ? "=".concat(t.getParameter(h)) : ""))
                }
            }
        }
    for (var p = 0, ae = Ct; p < ae.length; p++)
        for (var ie = ae[p], Q = 0, oe = Ft; Q < oe.length; Q++) {
            var ce = oe[Q],
                Ee = It(t, ie, ce);
            f.push("".concat(ie, ".").concat(ce, "=").concat(Ee.join(",")))
        }
...
var Tt = {
    ...
    contrast: lt,
    reducedMotion: ft,
    reducedTransparency: dt,
    hdr: vt,
    math: mt,
    pdfViewerEnabled: bt,
    architecture: yt,
    applePay: wt,
    privateClickMeasurement: kt,
    audioBaseLatency: Gt,
    dateTimeLocale: At,
    webGlBasics: Rt,
    webGlExtensions: Mt
...
var Yt = "$ if upgrade to Pro: https://fpjs.dev/pro";
...
function Xt(e) {
    ...
    return {
        score: n,
        comment: Yt.replace(/\$/g, "".concat(t))
    }
}

function Nt(e) {
    if (re()) return .4;
    if (W()) return te() && !(D() && H()) ? .5 : .3;
...
function Ht(e) {
    for (var n = "", t = 0, r = Object.keys(e).sort(); t < r.length; t++) {
        var a = r[t],
            u = e[a],
            i = "error" in u ? "error" : JSON.stringify(u.value);
...
function Ae(e) {
    return JSON.stringify(e, function(n, t) {
        return t instanceof Error ? Qe(t) : t
    }, 2)
}
            ...
            return R(this, void 0, void 0, function() {
                ...
                return M(this, function(s) {
                    switch (s.label) {
                        ...
                        case 1:
                            return u = s.sent(), i = Dt(u), (n || r != null && r.debug) && console.log("Copy the text below to get the debug data:\n\n```\nversion: ".concat(i.version, `
...
function Jt() {
    if (!(window.__fpjs_d_m || Math.random() >= .001)) try {
        ...
        e.open("get", "https://m1.openfpcdn.io/fingerprintjs/v".concat(Le, "/npm-monitoring"), !0), e.send()
    } catch (n) {
        console.error(n)
    }
}
...
function Ot(e) {
    ...
    return e === void 0 && (e = {}), R(this, void 0, void 0, function() {
        ...
        return M(this, function(u) {
            switch (u.label) {
                case 0:
                    return (!((n = e.monitoring) !== null && n !== void 0) || n) && Jt(), t = e.delayFallback, r = e.debug, [4, zt(t)];
                case 1:
                    return u.sent(), a = Et({
                        cache: {},
                        debug: r
...
var _t = {
    ...
    Kt = xe;
export {
    Ae as componentsToDebugString, _t as
    default, an as getFullscreenElement, sn as getUnstableAudioFingerprint, Ln as getUnstableCanvasFingerprint, Nn as getUnstableScreenFrame, Tn as getUnstableScreenResolution, Pe as getWebGLContext, Te as hashComponents, re as isAndroid, j as isChromium, te as isDesktopWebKit, qe as isEdgeHTML, Fe as isGecko, cn as isSamsungInternet, Ce as isTrident, W as isWebKit, Ot as load, $e as loadSources, Kt as murmurX64Hash128, zt as prepareForSources, Tt as sources, Qt as transformSource, We as withIframe
};