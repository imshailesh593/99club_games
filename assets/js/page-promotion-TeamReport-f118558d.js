...
function fe(f) {
    N();
    const l = (i, n) => {
            console.log("routes", j.options.routes[41]), j.options.routes.forEach(y => {
                y.name === i && (y.meta.keepAlive = n)
            })
        },
        C = (i, n) => {
            l(n, f.includes(i))
        ...
        setup(f) {
            ...
            return (o, a) => {
                ...
                return c(), m("div", he, [u(L, {
                    ...
                    "left-arrow": "",
                    onClickLeft: W
                }, null, 8, ["title"]), e("div", Re, [e("div", Ce, [u(pe, {
...
const xe = q(Ke, [
        ...
        ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/views/promotion/TeamReport/index.vue"]
    ]),
    ...
    z = f => (re("data-v-56f58e4b"), f = f(), de(), f),
    Ge = {
...
const et = q(Ze, [
        ...
        ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/views/promotion/TeamReport/TeamReportDetail/index.vue"]
    ]),
