const e = {
    ...
    tipPlsDoNotTransferInOutFrequently: 'Please do not transfer in and out frequently. Earnings will be calculated from {0} minute after deposit. If the cumulative amount of an earned amount is less than 0.01, the amount will not be counted in "earnings".',
    security: "Safe",
    ...
    turntableSatisfy: "Members who meet the requirements of <span>{0}</span> can participate in the bigwheel event. Need to bind a bank card. Hundreds of millions of cash and many other prizes are up for grabs. Get ready for endless surprises and grand prizes every day!",
    ...
    bigLotteryTip20: "The jackpot of the Big Lottery is determined on the daily betting amount of all users on the platform. For every <span>{0}</span> bet placed by users on this platform, the jackpot increases by {1}",
    bigLotteryTip21: "How to participate",
    bigLotteryTip22: "Users who participate in 【Super Lottery】do not need to pay any amount . They only need to use points to exchange for lottery tickets in order to participate.",
    ...
    bigLotteryTip28: "【Super Lottery】is an additional activity given to members by the platform.Members do not need to pay any additional costs.It is a large-scale reward activity brought to members, so that the platform has the final right of interpretation.",
    bigLotteryTip29: "Once you confirm participation in the lottery, you will need to wait for the draw results. Your points cannot be refunded",
    ...
    bigLotteryTip40: "The platform rewards players with different ratios of points based on their daily bets. The more they bet, the higher the ratio of rewards",
    ...
    withdrawAr3: "After approval, your balance will be withdrawn to <span>AR Wallet</span><br/> Please click <span>Enter AR Wallet</span> to <span>Sell ARB</span>",
    ...
    arbActive: "Activate",
    arbTip4: "AR Wallet",
    arbTip5: "AR Wallet is a third-party payment service platform that facilitates fast payments on the platform using ARB (digital currency)",
    ...
    arbTip10: "When you want to play games, you can quickly recharge to the <span>{0}</span>platform through AR Pay, with the recharge process taking only 5 seconds to complete",
    arbTip11: "When you need to withdraw money to your bank card, you can quickly sell ARB through UPI in your AR wallet to get rupees, and you can also get additional rewards!",
    ...
    arbTip10ios: "When you want to play games, you can quickly recharge to the <span>%@</span>platform through AR Pay, with the recharge process taking only 5 seconds to complete",
    ...
    localeChangeMessage: "The Application language has been successfully updated. For the changes to take effect, The application will be exited, please relaunch the application. Thank you!",
    ...
    code1006: "If you haven't recharged for 2 months, you need to recharge to receive the reward <br/> VIP1 (Recharge 100) Activate <br/> VIP 2 (Recharge 200)Activate <br/> VIP 3 (Recharge 300)Activate <br/> VIP4 and above enjoy lifetime benefits",
    ...
    safeNewTip2: "With guaranteed income, you can transfer out at any time, from the balance of the safe to the balance of the wallet, the entire amount must be transferred",
    ...
    Appeal: "Appeal",
    notice: "Notice",
    appealTip: "Please contact customer service within 48 hours after filling in the appeal, otherwise the platform will handle it based on specific circumstances.",
    ...
    followUs: "FOLLOW US",
    rajaText: "RAJA GAMES is owned and operated by Medium Rare India Pvt. Ltd., registration number: U12345KA2024PTC123456, registered address: 123 MG Road, Bengaluru, Karnataka, India. Contact us at support@rajagames.com. Payment agent company is Medium Rare Limited with address 45 Park Street, Level 3, Kolkata, West Bengal, India, and Registration number: HE 410775.",
    ...
    code624: "You have been banned from recharging due to abnormal recharging behavior, please contact customer service to lift the ban",
    arupiOrderTip2: "You still have an order that has not been completed, Please complete it first!",
    arupiOrderTip3: "Since we have not received the UTR you filled in at the arupi channel cashier, if you do not fill in the UTR, the recharge will not be successfully received. You can submit your recharge UTR certificate through appeal!",
    submitUtr: "Submit Utr",
    utr: "Utr",
    submitUtrtip: "After submitting UTR, if the review is successful, the recharge will normally be credited to the account within 30 minutes. If it is not credited within 30 minutes",
    ...
    braTips2: "The brand ({0}.COM) is operated by the Brazilian company ONEPAY MEIOS DE PAGAMENTO, in partnership with LOTERJ, starting from 10/04/2024, registered under No. SEI 150013/001113/2024.",
    ...
    arupiOrderTip4: "You did not fill in the UTR and the order could not be completed successfully. You can link KYC to automatically complete the order",
    ...
    safetyTip: "For the safety of your funds, when using Paytem App to pay, please make sure that the payment address is consistent with the cash register",
    platformArrival: "The platform only supports the following wallets for KYC self-confirmation of account arrival",
    followingWallets: "If you use the following wallets for payment transfer, you can select the wallet you use and receive OTP for automatic system confirmation",
    throughOTP: "After completing the connection through OTP, if you are transferring money for real, the system will automatically help you complete the order and add points",
    ...
    chooseBankWarmTips: "The system detects that you IFSC code can be matched with the following banks. Please select the bank you want to bind.",
    ...
    quickTips: "The system has detected that your UPI account for receiving payments may contain a mobile phone number, posing a risk of leakage. To prevent fraud, we recommend that you change to a UPI account that does not include a mobile phone number.",
    quickTips2: "If you insist on using your current account, do not trust scammers impersonating customer service representatives and do not send your OTP to anyone. The platform will not request OTPs from any user!",
    ...
    currentPaymentTips: "The system has detected that you have a withdrawal and need to obtain SMS verification again before you can withdraw normally.",
    ...
    code289: "The Maximum Number of Bank Cards Linked to This Phone Number Has Been Reached. Please Use a Different Phone Number to Link.",
    ...
    payPrivacy: "The platform will not store or disclose your personal information and will only use it for this payment verification.",
