...
const De = {
    ...
    cs = J({
        ...
        setup(S, {
            ...
            const g = $(!0),
                _ = a => {
                    g.value || r("changeLevel", i.value[a.activeIndex].id)
                },
                i = $([]);
            async function c() {
                var w;
...
const rs = Q(cs, [
        ...
        ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/components/Vip/VipCard.vue"]
    ]),
    ds = {
            ...
            return E({
                ...
                return t(), o("div", ds, [m(ie, {
                    ...
                    default: O(() => [(t(), o("div", {
                        ...
                        src: l(A)("main", "gold")
                    }, null, 8, $s), D(n(l(M)(d.balance, " ", 0)), 1)]), e("p", null, [m(c, {
                        name: "love"
                    }), D(n(l(M)(d.integral, " ", 0)), 1)])])) : (t(), o("div", gs, [e("p", fs, [m(c, {
                        name: `weal${d.id}`
...
const ws = Q(ys, [
        ...
        ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/components/Vip/Weal.vue"]
    ]),
    ks = {
    ...
    Gs = J({
        ...
        setup(S, {
            ...
            async function _(i) {
                ...
                c && (g(h.value), c != null && c.data && r("succeedDialog", {
...
const zs = Q(Gs, [
        ...
        ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/components/Vip/MyWelfare.vue"]
    ]),
...
const wn = Q(yn, [
        ...
        ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/components/Vip/RecordVsrule.vue"]
    ]),
    kn = {
        class: "vip"
    },
    ...
    On = J({
        ...
        setup(S) {
            ...
            async function s() {
                ...
                h(!0);
                const v = await B(Re());
                v && v != null && v.data && (u.value = v.data, i.value.level = (b = u.value) == null ? void 0 : b.vipLevel, i.value.getListVipLevel((H = u.value) == null ? void 0 : H.vipLevel), ((K = u.value) == null ? void 0 : K.vipLevel) > 0 && (c.value.levelMy = (W = u.value) == null ? void 0 : W.vipLevel, c.value.getListVipUserRewards((G = u.value) == null ? void 0 : G.vipLevel)), _.value.level = (z = u.value) == null ? void 0 : z.vipLevel, await _.value.getVipUserLevelDetail(), p.value = !0), h(!1)
            }
            re(() => {
                s()
            });
            ...
            function N(v) {
                ke(() => {
                    var b;
                    i.value.level = v, i.value.getListVipLevel(v), v <= ((b = u.value) == null ? void 0 : b.vipLevel) && (c.value.levelMy = v, c.value.getListVipUserRewards(v))
                })
            }
            ...
            return (v, b) => {
                ...
                }, null, 8, An), e("p", null, n(v.$t("settlementTime")), 1)])]), e("div", Dn, n(v.$t("vipTip18")), 1), f("vip卡片"), m(rs, {
                    ref_key: "vipCardRef",
                    ref: _,
