...
const m = _ => (G("data-v-82bb7bc5"), _ = _(), x(), _),
    J = {
        class: "package"
    },
    K = {
    ...
    m2 = D({
        ...
        setup(_) {
            const {
                ...
                onApply: r,
                onReceive: g,
                onApplyFirstCharge: C,
                store: d,
                time: L,
                bonusLimit: y,
                firstDeposiSendBonust: B,
                rewardRecordList: h
            } = j(), $ = () => {
                c.go(-1)
            }, H = () => {
            ...
            return N(() => {
                ...
                const Z = M("NavBar"),
                    I = M("svg-icon");
                return n(), o("div", J, [k(Z, {
                    title: a.$t("activityDestitle"),
                    placeholder: !1,
                    "left-arrow": "",
                    onClickLeft: $
                }, null, 8, ["title"]), e("div", K, [e("div", Q, [e("h3", null, t(a.$t("newMenberPackage")), 1), e("h4", null, t(a.$t("newMenberTip")) + "：", 1), e("p", null, [U, p(t(a.$t("newMenberRule")), 1)]), e("p", null, [q, p(t(a.$t("newMenberRule2")), 1)]), e("div", null, [e("div", {
                    class: "package-desc",
                    onClick: H
                }, t(a.$t("activityDestitle")), 1)])])]), s(d).firstDepositConfig ? (n(), O(E, {
                    key: 0,
                    name: a.$t("activityTime"),
                    tiplist: []
                }, {
                    default: z(() => [e("h2", W, t(s(L) || a.$t("lotteryActivityUnstarted")), 1)]),
                    _: 1
                }, 8, ["name"])) : u("v-if", !0), s(d).firstDepositConfig ? (n(), o("div", X, [e("div", Y, [e("div", e2, t(a.$t("conditionsRule")), 1), e("div", t2, t(a.$t("afterDayBonus")), 1), e("div", s2, t(a.$t("bonusLimit")), 1)]), e("ul", null, [e("li", null, [e("div", null, t(a.$t("newMemberDeposit")), 1), e("div", i2, [e("p", {
                    innerHTML: a.$t("todayBonus", [s(B)])
                }, null, 8, a2)]), e("div", null, [e("span", null, t(s(v)(s(y))), 1)])])])])) : u("v-if", !0), s(d).firstDepositConfig.rewardState == 0 ? (n(), o("div", n2, [k(I, {
                    name: "activityNote"
                }), p(" " + t(s(d).firstDepositConfig.isAutomaticDistribution ? a.$t("receiveTips") : a.$t("activityTip9")), 1)])) : u("v-if", !0), [0, 4].includes(s(d).firstDepositConfig.rewardState) ? u("v-if", !0) : (n(), o("div", o2, t(A[s(d).firstDepositConfig.rewardState]), 1)), [4].includes(s(d).firstDepositConfig.rewardState) ? (n(), o("div", {
                    key: 4,
                    onClick: S[0] || (S[0] = (...l) => s(C) && s(C)(...l)),
                    class: "package-item-btn d"
                }, t(A[s(d).firstDepositConfig.rewardState]), 1)) : u("v-if", !0), e("ul", l2, [(n(!0), o(b, null, V(s(h), l => (n(), o("li", {
                    class: "package-item",
                    key: l.id
                }, [e("div", c2, [e("p", null, t(a.$t("registrationFull", [l.registerDays])), 1)]), e("div", r2, [e("div", d2, [e("ul", null, [e("li", u2, [e("h3", null, t(s(v)(l.actualGrandTotalDeposit)), 1), p2, e("p", null, t(a.$t("grandTotalDeposit")), 1)]), e("li", _2, [e("h3", null, t(s(v)(l.actualTotalValidBet)), 1), C2, e("p", null, t(a.$t("totalValidBet")), 1)])]), e("div", v2, [e("span", null, t(a.$t("giftBonus")), 1), e("span", null, t(s(v)(l.giveAwayBonus)), 1)])]), e("div", g2, t(w[l.state]), 1)]), l.state === 3 ? (n(), o("div", {
                    key: 0,
                    class: "package-item-btn",
                    onClick: F => s(g)(l.id)
                }, t(a.$t("receive")), 9, f2)) : u("v-if", !0), l.state === 0 && l.operateState === 2 ? (n(), o("div", {
                    key: 1,
                    class: "package-item-btn apply",
                    onClick: F => s(r)(l.id)
                }, t(a.$t("activityApply")), 9, h2)) : u("v-if", !0), l.state === 0 && [0, 1].includes(l.operateState) ? (n(), o("div", k2, t(w[0]), 1)) : u("v-if", !0), [0, 3].includes(l.state) ? u("v-if", !0) : (n(), o("div", b2, t(w[l.state]), 1))]))), 128))])])
            }
        }
    });
const L2 = T(m2, [
        ["__scopeId", "data-v-82bb7bc5"],
        ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/views/activity/MemberPackage/index.vue"]
    ]),
    ...
    A2 = D({
        ...
        setup(_) {
            const i = c => c.length ? c[0] : {};
            return (c, f) => (n(!0), o(b, null, V(_.giftPackConfigList, (r, g) => (n(), o("div", {
                key: g
            }, [e("div", y2, t(c.$t("registrationFullTip", [r.registerDays])), 1), e("table", $2, [e("thead", w2, [e("th", null, t(c.$t("activeObject")), 1), e("th", null, t(c.$t("totalValidBets")), 1), e("th", null, t(c.$t("giftBonus")), 1)]), e("tbody", null, [(n(!0), o(b, null, V(r.configAwardList, (C, d) => (n(), o("tr", M2, [g >= d && d === 0 ? (n(), o("td", V2, t(c.$t("registrationDepositTip", [r.registerDays, r.grandTotalDeposit])), 1)) : u("v-if", !0), e("td", null, t(s(v)(C.totalValidBet)) + "+", 1), e("td", null, t(s(v)(C.giveAwayBonus)), 1)]))), 256))])]), r.configAwardList.length ? (n(), o("div", D2, [e("div", T2, [e("div", B2, t(c.$t("forexample")) + ":", 1)]), e("div", {
                class: "description",
                innerHTML: c.$t("registrationExample", [r.registerDays, r.grandTotalDeposit, i(r.configAwardList).totalValidBet, i(r.configAwardList).giveAwayBonus])
            }, null, 8, H2)])) : u("v-if", !0)]))), 128))
        }
    });
const S2 = T(A2, [
        ["__scopeId", "data-v-6fdd0edc"],
        ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/components/common/RulesTable.vue"]
    ]),
    R2 = {
    ...
    x2 = D({
        ...
        setup(_) {
            const {
                ...
                store: r,
                time: g,
                firstDepositTimeLiness: C,
                bonusLimit: d,
                firstDeposiSendBonust: L,
                giftPackConfigList: y
            } = j();
            return N(() => {
                f()
            }), (B, h) => {
                const $ = M("NavBar");
                return n(), o(b, null, [k($, {
                    title: s(i)("eventDetails"),
                    "left-arrow": "",
                    onClickLeft: h[0] || (h[0] = H => s(c).go(-1))
                }, null, 8, ["title"]), e("div", R2, [s(r).firstDepositConfig ? (n(), o("div", P2, [e("div", N2, [e("div", j2, t(s(i)("newMenberRule")), 1)]), e("div", Z2, [p(t(s(i)("activityTime")), 1), e("span", null, t(s(g)), 1), p("，" + t(s(i)("newMemberDeposit")), 1), e("span", I2, t(s(C)), 1), p(t(s(i)("newMemberDepositTime")) + " ", 1), e("span", {
                    innerHTML: s(i)("platformBonus", [s(L)])
                }, null, 8, F2), p("，" + t(s(i)("bonusLimit")), 1), e("span", O2, t(s(v)(s(d))), 1), p("，" + t(s(i)("receiveTips")) + "。 ", 1)])])) : u("v-if", !0), e("div", z2, [e("div", G2, t(s(i)("newMemberPlayGame")), 1), e("div", null, [k(S2, {
                    giftPackConfigList: s(y)
                }, null, 8, ["giftPackConfigList"])])])])], 64)
            }
        }
    });
const E2 = T(x2, [
        ["__scopeId", "data-v-6bb8da12"],
        ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/views/activity/MemberPackage/Rules/index.vue"]
    ]),
