...
const d = {
    ...
    f = s({
        ...
        setup(v) {
            const e = t(),
                r = n(() => String(e.currentRoute.value.query.url)),
                o = () => {
                    e.go(-1)
                };
            return (g, x) => {
                const a = c("NavBar");
                return p(), l("div", d, [i(a, {
                    "left-arrow": "",
                    onClickLeft: o,
...
const y = u(f, [
    ...
    ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/views/home/AllLotteryGames/WinTrxIframe/index.vue"]
]);
export {
    y as
    default
