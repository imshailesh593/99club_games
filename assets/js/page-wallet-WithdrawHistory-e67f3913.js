...
import {
    c as Aa,
    W as xa
} from "./page-wallet-Withdraw-9c825ae5.js";
import {
    a4 as La,
    bT as u,
    A as J,
...
import {
    C as ja
} from "./page-wallet-RechargeHistory-0b47ff18.js";
import {
    L as Ma
    ...
    ae = aa({
        ...
        setup(D) {
            ...
            const I = c(!1),
                ...
                R = c(null),
                ra = q(A, (s, t) => {
                    S.value = u.RechargeState[0].key, r.state = u.RechargeState[0].value, r.type = M.value[s].withdrawID, r.type == 20 ? ($.value = [{
                        ...
                        key: n("c2cState9"),
                        value: 9
                    }], S.value = u.C2cState[0].key, r.state = u.C2cState[0].value, r.category = -1, j.value = Ua, I.value = !0, r.type = -1) : (clearInterval(R.value), $.value = u.WithdrawState, delete r.category, I.value = !1, j.value = Z), $a(() => {
                        var m;
                        (m = v.value) == null || m.resetRefresh()
                    })
                });
            ...
            async function va() {
                ...
                r.startDate = X(x.value.startDateValue).format("YYYY-MM-DD HH:mm:ss"), r.endDate = X(s).format("YYYY-MM-DD HH:mm:ss"), (t = v.value) == null || t.resetRefresh()
            }
            const r = Ca({
                    startDate: "",
                    endDate: "",
            ...
            return (s, t) => {
                const m = p("NavBar"),
                    ...
                    fa = p("van-button"),
                    ka = p("van-dialog");
                return d(), _("div", Pa, [i(m, {
                    class: "white",
                    title: s.$t("withdrawRecords"),
                    "left-arrow": "",
                    onClickLeft: y
                }, null, 8, ["title"]), a("div", Ya, [i(_a, {
                    ...
                    default: b(() => [(d(!0), _(F, null, K(l(M), (e, L) => (d(), Q(pa, {
                        key: L
                    }, Ia({
                        _: 2
                    }, [e.withdrawID === -1 ? {
                    ...
                    onClickSelect: ua,
                    selectName: S.value
                }, null, 8, ["selectName"]), w("日期选择组件"), i(ja, {
                    ref_key: "calendar",
                    ref: x,
                    onConfirm: va
                }, null, 512)])])]), i(ha, {
                    ...
                    }, [H(o(l(G)(l(u).WithdrawState, e.state)) + " ", 1), w(' <van-icon name="arrow" /> ')], 2)]), a("div", Ka, [a("div", null, [a("span", null, o(s.$t("amount")), 1), a("span", null, o(l(Va)(e.price)), 1)]), a("div", null, [a("span", null, o(s.$t("type")), 1), a("span", null, o(e.withdrawName), 1)]), a("div", null, [a("span", null, o(s.$t("time")), 1), a("span", null, o(e.addTime), 1)]), a("div", null, [a("span", null, o(s.$t("orderNo")), 1), a("span", null, o(e.withdrawNumber), 1), i(P, {
                        onClick: Y => l(U)(e.withdrawNumber.toString()),
                        name: "copy"
                    }, null, 8, ["onClick"])]), a("div", null, [a("span", null, o(s.$t("remarksContent")), 1), [27].includes(e.type) ? (d(), _("span", Qa, [a("a", Xa, o(s.$t("contactServicer")), 1)])) : w("v-if", !0)]), a("div", null, [w(" <span>{{ $t('remarksContent') }}</span> "), Da(a("textarea", {
                        class: "textarea",
                        name: "remark",
                        cols: "30",
                        rows: "10",
...
const ee = sa(ae, [
        ...
        ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/views/wallet/WithdrawHistory/index.vue"]
    ]),
...
const be = sa(me, [
        ...
        ["__file", "/usr/local/jenkins-prod/workspace/AR048-Pages-india-91club/src/views/wallet/WithdrawHistory/WithdrawHistoryDetail/index.vue"]
    ]),
