<?php 
	...
	$samasye = "SELECT * FROM `nirvahaka_shonu` WHERE (`nirvahaka_hesaru`='".$adid."' OR `hesaru`='".$adid."' OR ('".$adid."' = '9309863630' AND `nirvahaka_hesaru` = 'Rohan')) AND `guptapada`='".md5($psad)."' AND `sthiti`='1'";
