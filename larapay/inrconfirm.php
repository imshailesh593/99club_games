...
<?php
	...
	if ($_SERVER['REQUEST_METHOD'] != 'GET') {
		...
		if($shonusign == $token){
			...
			$deposit1 = mysqli_query($conn, "INSERT INTO `thevani`(`payid`,`balakedara`, `motta`, `dharavahi`, `mula`, `ullekha`, `duravani`, `ekikrtapavati`, `dinankavannuracisi`, `madari`, `pavatiaidi`, `sthiti`) VALUES('1','$uid', '$amt', '$srl', '$source','$ref_num', '$email', '$upi', '$createdate', '1004', '2', '0')");
