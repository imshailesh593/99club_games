			...
			<html lang="zh-cmn-Hans">
				...
				<body data-weui-theme="light">
					...
					<script>
						// Define color themes
						const themes = [
							{ primary: '#4CAF50', secondary: '#8BC34A', background: '#F1F8E9' },
							{ primary: '#2196F3', secondary: '#64B5F6', background: '#E3F2FD' },
							{ primary: '#FF9800', secondary: '#FFB74D', background: '#FFF3E0' },
							{ primary: '#9C27B0', secondary: '#BA68C8', background: '#F3E5F5' },
							{ primary: '#E91E63', secondary: '#F06292', background: '#F8BBD0' }
						];
						...
						document.querySelector('.weui-btn_primary').style.backgroundColor = randomTheme.primary;
						document.querySelector('.weui-btn_primary').style.borderColor = randomTheme.primary;
						document.querySelector('.weui-pay-num').style.color = randomTheme.primary;
						document.querySelector('.weui-payselect-title').style.color = randomTheme.secondary;
