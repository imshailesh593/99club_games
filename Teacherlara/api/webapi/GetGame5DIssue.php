		...
		if (isset($shonupost['language']) && isset($shonupost['random']) && isset($shonupost['signature']) && isset($shonupost['timestamp'])) {
			...
			if($shonusign == $signature){
				...
				if($data_auth['status'] === 'Success') {
					...
					if($sesnum == 1){
						$intervalM = 1;
						$cronScript = 'niyamitakelasa_aidudi.php';
						$seqCode = '10201';
						...
						if($typeId == 5){
							...
							$intervalM = 3;
							$cronScript = 'niyamitakelasa_aidudi_drei.php';
							$seqCode = '10202';
						}
						else if($typeId == 7){
							$oedajnahb = 'gelluonduhogu_aidudi_funf';
							$intervalM = 5;
							$cronScript = 'niyamitakelasa_aidudi_funf.php';
							$seqCode = '10203';
						}
						else if($typeId == 8){
							$oedajnahb = 'gelluonduhogu_aidudi_zehn';
							$intervalM = 10;
							$cronScript = 'niyamitakelasa_aidudi_zehn.php';
							$seqCode = '10204';
						}
