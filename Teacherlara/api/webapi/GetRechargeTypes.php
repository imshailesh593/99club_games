		...
		if (isset($shonupost['language']) || isset($shonupost['payTypeId']) || isset($shonupost['payid']) || isset($shonupost['random']) || isset($shonupost['signature']) || isset($shonupost['timestamp'])) {
			...
			if($shonusign){
				...
				if($data_auth['status'] === 'Success') {
					...
					if($sesnum == 1){
						$sites = 'https://99club.vbrao.com/';
						
							if ($payid == 2) {
                            $data["rechargetypelist"]["0"]["payTypeID"] = (int)"1023";
                            $data["rechargetypelist"]["0"]["payID"] = (int)"2";
                            $data["rechargetypelist"]["0"]["payName"] = "PG-pay";
                            $data["rechargetypelist"]["0"]["paySysName"] = "923";
                            $data["rechargetypelist"]["0"]["miniPrice"] = (int)"200";
                            $data["rechargetypelist"]["0"]["maxPrice"] = (int)"30000";
                            $data["rechargetypelist"]["0"]["scope"] = "100|300|500|5000|10000|20000|30000|";
                            $data["rechargetypelist"]["0"]["paySendUrl"] = $sites."/larapay/wepay";
                            ...
                            $data["rechargetypelist"]["0"]["quickConfigList"] = [
                                ...
                                ["rechargeAmount" => 1000.0, "giftAmount" => 000.0],
                                ["rechargeAmount" => 5000.0, "giftAmount" => 00.0],
                                ["rechargeAmount" => 10000.0, "giftAmount" => 00.0],
                                 ["rechargeAmount" => 20000.0, "giftAmount" => 00.0],
                            ...
                            $data["rechargetypelist"]["1"]["payName"] = "UX-pay";
                            $data["rechargetypelist"]["1"]["paySysName"] = "923";
                            $data["rechargetypelist"]["1"]["miniPrice"] = (int)"200";
                            $data["rechargetypelist"]["1"]["maxPrice"] = (int)"20000";
                            $data["rechargetypelist"]["1"]["scope"] = "200|600|1200|3000|10000|20000";
                            $data["rechargetypelist"]["1"]["paySendUrl"] = $sites."/larapay/wepay";
                            ...
                            $data["rechargetypelist"]["1"]["quickConfigList"] = [
                                ...
                                ["rechargeAmount" => 1200.0, "giftAmount" => 0.0],
                            ...
                            $data["rechargetypelist"]["2"]["payName"] = "FUX-pay";
                            ...
                            $data["rechargetypelist"]["2"]["scope"] = "500|1400|3000|8000|20000|50000";
                            $data["rechargetypelist"]["2"]["paySendUrl"] = $sites."/larapay/wepay";
                            ...
                            $data["rechargetypelist"]["2"]["quickConfigList"] = [
                                ["rechargeAmount" => 500.0, "giftAmount" => 00.0],
                                ["rechargeAmount" => 1400.0, "giftAmount" => 00.0],
                                ["rechargeAmount" => 3000.0, "giftAmount" => 00.0],
                                ["rechargeAmount" => 8000.0, "giftAmount" => 00.0],
                                ["rechargeAmount" => 20000.0, "giftAmount" => 00.0],
                           ...
                           $data["rechargetypelist"]["3"]["payTypeID"] = (int)"1029";
                            ...
                            $data["rechargetypelist"]["3"]["maxPrice"] = (int)"15000";
                            $data["rechargetypelist"]["3"]["scope"] = "100|250|750|1500|3500|15000";
                            $data["rechargetypelist"]["3"]["paySendUrl"] = $sites."/larapay/wepay";
                            ...
                            $data["rechargetypelist"]["3"]["quickConfigList"] = [
                                ...
                                ["rechargeAmount" => 250.0, "giftAmount" => 00.0],
                                ["rechargeAmount" => 750.0, "giftAmount" => 00.0],
                                ["rechargeAmount" => 1500.0, "giftAmount" => 00.0],
                                ["rechargeAmount" => 3500.0, "giftAmount" => 00.0],
                            ...
                            $data["rechargetypelist"]["4"]["payName"] = "GG-pay";
                            ...
                            $data["rechargetypelist"]["4"]["paySendUrl"] = $sites."/larapay/wepay";
                            ...
                            $data["rechargetypelist"]["0"]["paySendUrl"] = $sites."/larapay/wepay";  //$sites."/#/wallet/OtherPay?type=upi";
                            $data["rechargetypelist"]["0"]["parameters"] = '';
                            $data["rechargetypelist"]["0"]["startTime"] = "00:00";
                            $data["rechargetypelist"]["0"]["endTime"] = "24:00";
                            $data["rechargetypelist"]["0"]["rechargeRifts"] = (float)"0.00";
                            ...
                            $data["rechargetypelist"]["0"]["paySendUrl"] = $sites."/larapay/usdt";
                            $data["rechargetypelist"]["0"]["parameters"] = '';
                            ...
                            $data["rechargetypelist"]["1"]["paySendUrl"] = $sites."/larapay/usdtuu";
                            $data["rechargetypelist"]["1"]["parameters"] = '';
