        ...
        if($shonusign == $signature){
            ...
            if($data_auth['status'] === 'Success') {
                ...
                if($sesnum == 1){
                    ...
                    // ✅ CHANGE 1: Sirf is user ki history (WHERE byabaharkarta = $shonuid)
                    ...
                    // ✅ CHANGE 2: Sirf is user ki total count (WHERE byabaharkarta = $shonuid)
                    $samasye_ondu = "SELECT COUNT(*) as total FROM ".$jayshriram." WHERE byabaharkarta = $shonuid";
                    $samasyephalitansa_ondu = $conn->query($samasye_ondu);
                    $total_row = $samasyephalitansa_ondu->fetch_assoc();
                    $samasyephalitansa_sankhye = $total_row['total'];
