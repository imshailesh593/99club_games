		...
		if (isset($shonupost['language']) && isset($shonupost['random']) && isset($shonupost['signature']) && isset($shonupost['timestamp'])) {
			...
			if($shonusign == $signature){
				...
				if($data_auth['status'] === 'Success') {
					...
					if($sesnum == 1){
						$intervalM = 1;
						$cronScript = 'niyamitakelasa.php';
						$seqCode = '10001';
						$oedajnahb = 'gelluonduhogu';
						if($typeId == 1){
							$oedajnahb = 'gelluonduhogu';
							$intervalM = 1;
							$cronScript = 'niyamitakelasa.php';
							...
							$oedajnahb = 'gelluonduhogu_drei';
							$intervalM = 3;
							$cronScript = 'niyamitakelasa_drei.php';
							$seqCode = '10002';
						}
						else if($typeId == 3){
							$oedajnahb = 'gelluonduhogu_funf';
							$intervalM = 5;
							$cronScript = 'niyamitakelasa_funf.php';
							$seqCode = '10003';
						}
						else if($typeId == 4){
							$oedajnahb = 'gelluonduhogu_zehn';
							$intervalM = 0.5;
							$cronScript = 'niyamitakelasa_zehn.php';
							$seqCode = '10005';
						}

						$intervalSec = intval($intervalM * 60);
